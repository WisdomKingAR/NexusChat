...
async def run_test():
    ...
    try:
        ...
        # -> Type the wrong credentials into the email and password fields and click the 'Sign In' button (input into indexes 63 and 64, then click index 67).
        frame = context.pages[-1]
        # Input text
        elem = frame.locator('xpath=/html/body/div/div/div/div/form/div/div/input').nth(0)
        await asyncio.sleep(3); await elem.fill('not-a-real-user@example.com')
