...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields with admin@test.com / Test@123 and click Sign In.
        ...
        # -> Click the 'Sign In' button to submit the login form and trigger navigation to the main app (index 66). ASSERTION: Clicking the Sign In button should start the login flow / navigation.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/div/div/form/button').nth(0)
        await asyncio.sleep(3); await elem.click()
