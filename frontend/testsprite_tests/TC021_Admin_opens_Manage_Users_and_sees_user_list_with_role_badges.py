...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /login (per test step: 'Navigate to /login')
        ...
        # -> Click the 'Manage System' control in the sidebar to open system management (this should expose the Manage Users control).
        frame = context.pages[-1]
        # Click element
